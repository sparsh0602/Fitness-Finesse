...
export default function weightGain() {
  return (
    ...
    <div>
      ...
      <div className="weightLossSubheading">What is a Healthy Weight Range?</div>
      <div className="weightLossSubIntro">Your Body Mass Index (BMI) determines your healthy weight range. To calculate your BMI, divide your body weight by your height in meter square. The answer you get is your BMI.
      ...
      <div className="weightLossSubheading">Reasons for Being Underweight:</div>
      <div className="weightLossSubIntro">High Metabolism – Everyone has a different body type. People with a high metabolic rate remain lean and fail to gain weight, no matter how much they eat in a day. <br /><br />
      ...
      <div className="weightLossSubheading">Tips to Gain Weight in a Healthy Way:</div>
      <div className="weightLossSubSubHeading">1. High-Calorie Food</div>
      <div className="weightLossSubIntro">To gain weight healthily, eat foods like banana, avocados, full-fat milk., that are high in calories and full of nutrients.
      ...
      <div className="weightLossSubIntro">Proteins are what make up our muscles. The absence of the recommended protein intake can make your efforts to gain weight futile.
      ...
      <div className="weightLossSubIntro">Stress causes a loss of appetite, and in some, it increases their appetite. In both cases, stress is extremely harmful to your mental and physical health.
      ...
      <div className="weightLossSubIntro">Your aim should be to gain lean muscle mass and not fat mass. Therefore, it is crucial to work out and do strength training at least 2-4 times a week.
      ...
      <div className="weightLossSubIntro">A good night’s sleep can do wonders for your health. A good quality sleep of approximately 8 hours helps to strengthen muscle mass and keeps your body fit. Lack of sleep is a contributing factor to hormonal imbalance.
